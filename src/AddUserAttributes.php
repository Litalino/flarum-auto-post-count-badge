...
namespace Litalino\AutoPostCountBadge;
...
class AddUserAttributes
{
    ...
    private function getBadgeForLevel(int $level): string
    {
        switch ($level) {
            ...
            case $level === 9:
                return $this->getValue('levelNine', 'fas fa-bible');
            case $level === 10:
                return $this->getValue('levelTen', 'fas fa-user-shield');
            default:
                return '';
        }
    }
    ...
    private function getBadgeLabelForLevel(int $level): string
    {
        switch ($level) {
            ...
            case $level === 9:
                return $this->getValue('badgeNine', 'God*');
            case $level === 10:
                return $this->getValue('badgeTen', '*Untouchable*');
            default:
                return '';
        }
    }
