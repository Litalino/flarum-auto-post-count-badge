...
export default class AutoPostBadgePage extends ExtensionPage {
  ...
  content() {
    return (
      <div className="container">
        <div className="row">
          <div className="column">{this.colorbg1ManagerItems().toArray()}</div>
          <div className="column">{this.colorbg2ManagerItems().toArray()}</div>
        </div>
        <div className="row">
  ...
  colorbg1ManagerItems() {
    const items = new ItemList();

    items.add(
      'heading',
      <div className="AppearancePage-colors-input_">
        <h2 class="h2titleext">{app.translator.trans('justoverclock-auto-post-count-badge.admin.settings.color.bg1')}</h2>
        <p class="helpText">
          
        </p>
        <Button onclick={this.saveSettings.bind(this)} className="Button Button--primary autopost"><i className="fas fa-save autopost" /></Button>
        {this.buildSettingComponent({
          type: 'color-preview',
          setting: 'justoverclock-auto-post-count-badge.bgColor',
          placeholder: '#d7ffcc',
  ...
  colorbg2ManagerItems() {
    const items = new ItemList();

    items.add(
      'heading',
      <div className="AppearancePage-colors-input_">
        <h2 class="h2titleext">{app.translator.trans('justoverclock-auto-post-count-badge.admin.settings.color.bg2')}</h2>
        <p class="helpText">
        ...
        {this.buildSettingComponent({
          type: 'color-preview',
          setting: 'justoverclock-auto-post-count-badge.bgColorTwo',
          placeholder: '#ffffff',
    ...
    items.add(
      ...
      <div className="formTen">
        ...
        <input
          ...
          bidi={this.setting('justoverclock-auto-post-count-badge.levelTen')}
        />
        <Button onclick={this.saveSettings.bind(this)} className="Button Button--primary autopost">
          <i className="fas fa-save autopost" />
        </Button>
    ...
    items.add(
      ...
      <div className="formTen">
        ...
        <input
          ...
          bidi={this.setting('justoverclock-auto-post-count-badge.badgeTen')}
        />
        <Button onclick={this.saveSettings.bind(this)} className="Button Button--primary autopost">
          <i className="fas fa-save autopost" />
        </Button>
